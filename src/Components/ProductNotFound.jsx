  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="text-center p-8 bg-white border border-gray-300 rounded-lg shadow-lg max-w-md transform transition-all hover:scale-105 duration-300 ease-in-out">
        <div className="mb-6">
          <img
            src="/VestidosDestacados/notfound.avif" // Imagen placeholder para ropa masculina (puedes agregar una más específica)
        ...
        <a
          href="https://wa.me/5493812062925"
          className="inline-block px-6 py-2 text-white bg-rosa-pastel rounded-full text-lg font-semibold hover:bg-blue-700 transition-colors"
        >

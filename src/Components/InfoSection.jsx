...
const InfoSection = () => {
  ...
  const items = [
    {
      icon: <FaShippingFast className="text-rosa-pastel text-5xl" />,
      title: 'Envíos',
      description: 'A todo el país.'
    },
    {
      icon: <FaCreditCard className="text-rosa-pastel text-5xl" />,
      title: 'Pagos',
      description: 'Aceptamos tarjetas, transferencia o en efectivo.'
    },
    {
      icon: <FaWhatsapp className="text-rosa-pastel text-5xl" />,
      title: 'Consultas',
